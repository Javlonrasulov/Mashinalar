...
function usePageTitle() {
  ...
  const ordered: { path: string; end?: boolean; key: string }[] = [
    ...
    { path: '/vehicles/insurance', end: true, key: 'vehiclesSubNavInsurance' },
    { path: '/vehicles/gas-balloon', end: true, key: 'vehiclesSubNavGasBalloon' },
    { path: '/vehicles/history', end: true, key: 'vehiclesSubNavFleetHistory' },
    { path: '/vehicles/categories', end: true, key: 'navVehicleCategories' },
